...
export function IssueCard({ issue, onClick }: IssueCardProps) {
    ...
    return (
        <div
            onClick={onClick}
            className="group relative flex flex-col gap-4 p-5 rounded-2xl border border-white/5 bg-[#121620]/40 hover:bg-[#1E2332]/60 hover:border-white/10 transition-all cursor-pointer overflow-hidden"
        >
