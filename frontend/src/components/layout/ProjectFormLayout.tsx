                ...
                {stepInfo && (
                    <div className="flex flex-col items-end gap-1">
                        ...
                        <div className="flex gap-1">
                            {/* Linea blu per lo step corrente, grigia per gli altri. (Qui statica, la dinamizziamo usando stepInfo se serve, o la teniamo semplice) */}
                            <div className={`h-1 rounded-full w-4 ${stepInfo.includes("1") ? "bg-[#5671F6]" : "bg-white/10"}`} />
                            <div className={`h-1 rounded-full w-4 ${stepInfo.includes("2") ? "bg-[#5671F6]" : "bg-white/10"}`} />
                        </div>
                    </div>
                )}
            </div>
